 ...
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="?c=usuarioambiente">Cuentadantes asignados</a></li>
              </ul>
            </li>
            <li class="dropdown">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Cuentadantes asignados</h4>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <?php foreach($this->model->Listar() as $r): ?>
                            ...
                            <td><?php echo $r->NOMUSU; ?></td>
                                <td><?php echo $r->NOMAMB; ?></td>
                                <td><?php 
                                echo $r->FECHA_ENTRADA;
                                ?></td>
                                <td>
                                    <a class="btn btn-danger" onclick = "redirigir(<?php echo $r->ID_ASIGNACION; ?>)" >Terminar</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
...
var href = '?c=usuarioambiente&a=Desactivar&ID_ASIGNACION='+ id;

swal({
  title: "¿Esta seguro de terminar esta asignación?",
  text: "Con esta acción el usuario no sera responsable del ambiente ",
  icon: "warning",
