...
<head>
  ...
  <title>SICAAS|Usuario ambiente</title>
  <!-- General CSS Files -->
...
<?php if ($user->ID_ROL ==1) {
 ...
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a class="nav-link" href="?c=usuarioambiente&a=Nuevo">Asignar cuentadante</a></li>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Asignar usuario a un ambiente</h4>
                  </div>
                  <div class="card-body">
                  <form action="?c=usuarioambiente&a=Guardar" method="post">
                    <div class="form-row">
                    <div class="form-group col-md-6">
                      <label>Cuentadante</label>
                      <label class="text-danger">*</label>
                      <select class="custom-select" name="ID_USUARIO" required>
                        <option selected value="0">Seleccione un cuentadante: </option>
                        <?php
                            foreach ($this->model->listar_cuentadante() as $cat): ?>
                                <option value="<?php echo $cat->ID_USUARIO ?>"><?php echo $cat -> NOMBRE ?></option>
                            <?php endforeach; ?>
                      </select>
                      </div>
                      <div class="form-group col-md-6">
                      ...
                      <select class="custom-select" name="ID_AMBIENTE" required>
                        <option selected value="0">Seleccione un ambiente: </option>
                            <?php
                                foreach ($this->model->listar_ambiente() as $cat): ?>
                                    <option value="<?php echo $cat->ID_AMBIENTE ?>"><?php echo $cat->NOMBRE_A . " - " . $cat->NOMBRE  ?></option>
                            <?php endforeach; ?>
                      </select>
                      </div>
                    </div>
