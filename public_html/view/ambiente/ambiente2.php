 ...
 ?>
      ...
      <div class="main-content">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Ambientes inactivos</h4>
                  </div>
                  <div class="card-body">
        ...
        <tr>
            ...
            <td>
                <a  class="btn btn-danger" onclick="redirigir(<?php echo $r->ID_AMBIENTE; ?>)" >Habilitar</a>
            </td>
        </tr>
    <?php endforeach; ?>
...
var href = '?c=ambiente&a=activar&ID_AMBIENTE='+id;
swal({
  title: "¿Esta seguro?",
  text: "Con esta acción habilitará este ambiente!",
  icon: "warning",
