 ...
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li  class="active"><a class="nav-link" href="?c=ambiente&a=Listus3&ID_USUARIO=<?php echo $user->ID_USUARIO; ?>">Mis ambientes</a></li>
              </ul>
            </li>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Mis ambientes asignados</h4>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
<?php foreach($this->model->Listarasig($VALUES) as $r): ?>
        <tr>
         <td><?php echo $r->ID_ASIGNACION; ?></td>
