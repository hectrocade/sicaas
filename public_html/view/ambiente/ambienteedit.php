            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Editar ambiente</h4>
                  </div>
                  <div class="card-body">
                  <form action="?c=ambiente&a=Editar" method="post">
                    <div class="form-row">
                    <input type="hidden" name="ID_AMBIENTE" value="<?php echo $ambiente->ID_AMBIENTE; ?>" required>
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Nombre</label>
                        <input type="text" class="form-control" value="<?php echo $ambiente->NOMBRE; ?>" name="NOMBRE" id="inputEmail4" placeholder="Nombre del ambiente">
                      </div>
                      <div class="form-group col-md-6">
                      <label>Sede</label>
                      <select class="custom-select" name="ID_SEDE" id="ID_SEDE">
                        <?php
                foreach ($this->model->listar_sede() as $sed): ?>
                 <script>
                    function asignarS(){
                        document.getElementById("ID_SEDE").value = <?php echo $ambiente->ID_SEDE; ?>;
                    }
                </script>
                <option value="<?php echo $sed -> ID_SEDE ?>"><?php echo $sed -> NOMBRE ?></option>
              <?php endforeach; ?>
