...
<?php if ($user->ID_ROL ==1) {
 ...
 ?>
            ...
            <li class="dropdown active">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="bookmark"></i><span>Ambiente</span></a>
              <ul class="dropdown-menu">
                <li class="active"><a class="nav-link" href="?c=ambiente&a=Listus2">Consultar Ambiente</a></li>
...
<?php if ($user->ID_ROL ==1) {
 ...
 ?>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Consultar ambiente</h4>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
                      <form action="?c=ambiente&a=Index2" method="post">
                      ...
                      <select class="custom-select" name="OPTION" id="selectoption">
                        ...
                        <option value="1">Nombre del ambiente</option>
                        <option value="2">Ambientes activos</option>
                        <option value="3">Ambientes inactivos</option>
                      </select>
                    </div>
  ...
  <script src="assets/js/ambiente.js"></script>
</body>
