...
<?php if ($user->ID_ROL ==1) {
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                <li  class="active"><a class="nav-link" href="?c=ambiente&a=Nuevo">Registrar ambiente</a></li>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Registrar ambiente</h4>
                  </div>
                  <div class="card-body">
                  <form action="?c=ambiente&a=Guardar" method="post">
                    <div class="form-row">
                      ...
                      <label>Sede</label>
                      <label class="text-danger">*</label>
                      <select class="custom-select" name="ID_SEDE">
                        <option selected value="0">Seleccione una sede</option>
                        <?php
