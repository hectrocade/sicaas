...
<?php if ($user->ID_ROL ==1) {
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a href="?c=activo&a=Nuevo">Registrar activo</a></li>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Registrar activo</h4>
                  </div>
                  <div class="card-body">
                  <form action="?c=activo&a=Guardar" method="post">
                    <div class="form-row">
                      ...
                      <select class="custom-select" name="ID_CATEGORIA" required>
                        ...
                        <?php
                    foreach ($this->model->listar_categoria() as $cat): ?>
