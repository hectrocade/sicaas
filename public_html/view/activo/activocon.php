...
<?php if ($user->ID_ROL ==1) {
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="?c=activo&a=consultarA">Consultar activo</a></li>
              </ul>
            </li>
            <li class="dropdown">
 ...
 ?>
            ...
            <li class="dropdown active">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="tablet"></i><span>Activos</span></a>
              <ul class="dropdown-menu">
                <li class="active"><a href="?c=activo&a=consultarA2">Consultar activo</a></li>
              </ul>
            </li>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Consultar activo</h4>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
                      <form action="?c=activo&a=Index" method="post">
                      <label>Seleccione el tipo de consulta que desea realizar</label>
                      <label class="text-danger">*</label>
                      <select class="custom-select" name="OPTION" id="selectactivo">
                        <option selected value="0">Seleccione una consulta</option>
                        <option value="1">Todos</option>
                        <option value="2">Serial del activo</option>
                        <option value="3">Marca del activo</option>
                        <option value="4">Nombre de la categoría</option>
                        <option value="5">Activos existentes</option>
                        <option value="6">Activos retirados</option>

                      </select>
                    </div>
                    <div class="form-group" id="datoactivo"  style="display:none">
                      <label for="inputAddress2">Dato a consultar</label>
                      <label class="text-danger">*</label>
                      <input type="text" class="form-control" name="VALUE"
                        placeholder="Digite el dato a consultar">
                    </div>
                    <div class="form-row">
                  ...
                  <div class="card-footer text-right">
                    ...
                    <button class="btn btn-primary mr-1" type="submit">Consultar</button>
  ...
  <script src="assets/js/activo.js"></script>
