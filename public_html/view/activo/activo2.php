 ...
 ?>
      ...
      <div class="main-content">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Activos retirados</h4>
                  </div>
                  <div class="card-body">
        ...
        <tr>
            ...
            <td>
                <a  class="btn btn-danger" onclick="redirigir(<?php echo $r->ID_ACTIVO; ?>)" >Habilitar</a>
            </td>
        </tr>
    <?php endforeach; ?>
...
var href = '?c=activo&a=activar&ID_ACTIVO='+id;
swal({
  title: "¿Está seguro?",
  text: "Con esta acción habilitará este activo",
  icon: "warning",
