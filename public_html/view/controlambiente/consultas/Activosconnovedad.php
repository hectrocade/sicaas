 ...
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a class="nav-link" href="?c=control_ambiente&a=ListAAN">Activos con novedad</a></li>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Activos con novedad</h4>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
                      <form action="?c=control_ambiente&a=Index3" method="post">
                      ...
                      <select class="custom-select" name="OPTION" id="selectoption">
                        ...
                        <option value="2">Nombre del ambiente</option>
                      </select>
                    </div>
