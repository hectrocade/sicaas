 ...
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a class="nav-link" href="?c=control_ambiente&a=ListAUI">Ambientes usados</a></li>
                ...
                <div class="card-header">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      <form action="?c=control_ambiente&a=Index1" method="post">
                      ...
                      <select class="custom-select" name="OPTION" id="selectoption">
                        ...
                        <option value="2">Identificacion del usuario</option>
                        <option value="3">Nombre del usuario</option>
                      </select>
                    </div>
