 ...
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a class="nav-link" href="?c=control_ambiente&a=ListSA">Seguimiento ambiente</a></li>
              </ul>
            </li>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Seguimiento del ambiente</h4>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
                      <form action="?c=control_ambiente&a=Index5" method="post">
                      <label for="inputAddress2">Nombre del ambiente</label>
                      <label class="text-danger">*</label>
                      <input type="text" class="form-control" name="VALUE"
                        placeholder="Digite el nombre del ambiente a consultar">
                    </div>
