 ...
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a class="nav-link" href="?c=control_ambiente&a=ListNRPU">Novedades registradas</a></li>
...
<?php if ($user->ID_ROL ==1) {
 ...
 ?>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Novedades registradas por instructores</h4>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
                      <form action="?c=control_ambiente&a=Index2" method="post">
                      <label>Seleccione el tipo de consulta que desea realizar:</label>
                      <label class="text-danger">*</label>
                      <select class="custom-select" name="OPTION" id="selectoption">
                        <option selected value="0">Seleccione una consulta</option>
                        <option value="1">Todos</option>
                        <option value="3">Identificacion del usuario</option>
                        <option value="4">Nombre del usuario</option>
                      </select>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <label class="text-danger">*</label>
                        <input type="date" class="form-control" name="F_I"  placeholder="Nombre del ambiente">
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Fecha final</label>
                        <label class="text-danger">*</label>
                        <input type="date" class="form-control" name="F_F"  placeholder="Nombre del ambiente">
                      </div>
                    </div>
  ...
  <script src="assets/js/novedadregistrada.js"></script>
</body>
