                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                        <?php foreach($this->model->Listar2($OPTION,$VALUE,$F_I,$F_F) as $r): ?>
        <tr>
            ...
            <td><?php echo $r->TIPO_NOVEDAD; ?></td>
            <td><?php echo $r->NOMBRE_CATEGORIA; ?> <?php echo $r->MARCA; ?>  <?php echo $r->SERIAL_A; ?></td>
