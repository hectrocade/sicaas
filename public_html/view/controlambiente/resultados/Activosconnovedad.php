                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                        <?php foreach($this->model->Listar3($OPTION,$VALUE) as $r): ?>
        <tr>
       
        <td><?php echo $r->NOMBRE_A; ?></td>
            <td><?php echo $r->NOMBRE_CATEGORIA; ?> <?php echo $r->MARCA; ?></td>
            
            <td><?php echo $r->SERIAL_A; ?></td>
            <td><?php if($r->ESTADO==1){echo "Activo";} else{ echo "Inactivo";} ?></td>
