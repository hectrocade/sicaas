              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Seguimiento del ambiente <?php echo $VALUE; ?></h4>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                        <?php foreach($this->model->Listar5($VALUE,$F_I,$F_F) as $r): ?>
        <tr>
            ...
            <td><?php if($r->DESCRIPCION_AMBIENTE==""){ echo "Ninguna"; }else{echo $r->DESCRIPCION_AMBIENTE;}   ?></td>
