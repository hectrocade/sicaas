...
<body>
 ...
 ?>
            ...
            <li class="active"><a class="nav-link" href="?c=control_ambiente&a=Nuevo"><i  data-feather="clipboard"></i><span>Registrar</span></a></li>
            <li class="dropdown">
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Registrar control de ambiente</h4>
                  </div>
                  <div class="card-body">
                  <form action="?c=control_ambiente&a=Guardar" method="post">
                  <input type="hidden" name="ID_USUARIO" value="<?php echo $user->ID_USUARIO;?>">
                    <div class="form-row">
                      <div class="form-group col-md-6">
                      <label>Seleccione el ambiente</label>
                      <label class="text-danger">*</label>
                      <select class="custom-select" name="ID_AMBIENTE">
                        <option selected value="0">Seleccione un ambiente</option>
                        <?php
                        foreach ($this->model->listar_ambiente() as $ambiente): ?>
                            <option value="<?php echo $ambiente -> ID_AMBIENTE ?>"><?php echo $ambiente -> NOMBRE ?></option>
                        <?php endforeach; ?>
                      </select>
                      </div>
                      <div class="form-group col-md-6">
                      <label>¿El ambiente presenta novedades?</label>
                      <label class="text-danger">*</label>
                      <select class="custom-select" id="selectoption" name="INCONSISTENCIA">
