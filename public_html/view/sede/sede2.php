              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Sedes inactivas</h4>
                  </div>
                  <div class="card-body">
                        ...
                        <?php foreach($this->model->Listar($OPTION,$VALUE) as $r): ?>
                            <tr>
                                ...
                                <td><?php 
                                    ...
                                    ?></td>
                                <td>
                                    <a class="btn btn-success" onclick="redirigir(<?php echo $r->ID_SEDE; ?>)" >Activar</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
...
var href = '?c=sede&a=Activar&ID_SEDE='+ id;
swal({
  title: "¿Esta seguro?",
  text: "Con esta acción habilitara esta SEDE!",
  icon: "warning",
