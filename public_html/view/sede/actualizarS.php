            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Editar Sede</h4>
                  </div>
                  <div class="card-body">
                  <form action="?c=sede&a=Editar" method="post">
                    <div class="form-row">
                    <input type="hidden" name="ID_SEDE" value="<?php echo $sede->ID_SEDE; ?>" required> 
                    <div class="form-group col-md-6">
                        <label for="">Nombre</label>
                        <label class="text-danger">*</label>
                        <input type="text" class="form-control" name="NOMBRE" id="" placeholder="Nombre de la sede" value="<?php echo $sede->NOMBRE; ?>" required>
                      </div>
                      <div class="form-group col-md-6">
                        <label for="">Dirección</label>
                        <label class="text-danger">*</label>
                        <input type="text" class="form-control" name="DIRECCION" id="" placeholder="Dirección de la sede" value="<?php echo $sede->DIRECCION; ?>" required>
                      </div>
                      <div class="form-group col-md-6">
                        <label for="">Teléfono</label>
                        <label class="text-danger">*</label>
                        <input type="text" class="form-control" name="TELEFONO" id="" placeholder="Teléfono de la sede" value="<?php echo $sede->TELEFONO; ?>" required>
                      </div>  
                    </div>
                    <div class="form-row">
