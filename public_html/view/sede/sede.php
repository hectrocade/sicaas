              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Sedes</h4>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <?php foreach($this->model->Listar($OPTION,$VALUE) as $r): ?>
                            <tr>
                                ...
                                <td>
                                    <a  class="btn btn-primary" href="?c=sede&a=Crud&ID_SEDE=<?php echo $r->ID_SEDE; ?>">Editar</a>
                                </td>
                                <td>
                                    <a  class="btn btn-danger" onclick="redirigir(<?php echo $r->ID_SEDE; ?>)" >Inhabilitar</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
