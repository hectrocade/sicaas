 ...
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a class="nav-link" href="?c=sede&a=consultarS">Consultar sede</a></li>
              </ul>
            </li>
            <?php } ?>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Consultar sede</h4>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
                      <form action="?c=sede&a=Index" method="post">
                      <label>Seleccione el tipo de consulta que desea realizar:</label>
                      <label class="text-danger">*</label>
                      <select class="custom-select" name="OPTION" id="selectsede" required>
                        <option selected value="0">Seleccione una consulta</option>
                        <option value="1">Todas</option>
                        <option value="2">Nombre de la sede</option>
                        <option value="3">Sedes inactivas</option>
                      </select>
                    </div>
                    <div class="form-group" id="datosede" style="display:none" >
