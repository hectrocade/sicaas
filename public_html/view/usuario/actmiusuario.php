            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Actualizar datos: <?php echo $usuario->NOMBRE; ?></h4>
                  </div>
                  <div class="card-body">
                  <form action="?c=usuario&a=Editar2" method="post">
                    <div class="form-row">
                    <input type="hidden" name="ID_USUARIO" value="<?php echo $usuario->ID_USUARIO; ?>" required>
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Celular</label>
                        <input type="text" class="form-control" value="<?php echo $usuario->CELULAR; ?>" name="CELULAR" id="inputEmail4" placeholder="Numero de celular">
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Telefono</label>
                        <input type="text" class="form-control" value="<?php echo $usuario->TELEFONO; ?>" name="TELEFONO" id="inputEmail4" placeholder="Numero telefonico">
                      </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="<?php echo $usuario->DIRECCION; ?>" name="DIRECCION" id="inputEmail4" placeholder="Dirección de residencia">
                      </div>
                  </div>
