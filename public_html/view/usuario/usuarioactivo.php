 ...
 ?>
      ...
      <div class="main-content">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Usuarios activos</h4>
                  </div>
                  <div class="card-body">
        ...
        <tr>
            ...
            <td>
                <a  class="btn btn-danger" onclick="redirigir1(<?php echo $r->ID_USUARIO; ?>)">Inhabilitar</a>
            </td>
        </tr>
    <?php endforeach; ?>
...
var href = '?c=usuario&a=Desactivar&ID_USUARIO='+id;
swal({
  title: "¿Esta seguro?",
  text: "Con esta acción desactivará al usuario",
  icon: "warning",
