 ...
 ?>
      ...
      <div class="main-content">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Usuarios inactivos</h4>
                  </div>
                  <div class="card-body">
        ...
        <tr>
            ...
            <td>
                <a  class="btn btn-danger" onclick="redirigir1(<?php echo $r->ID_USUARIO; ?>)">habilitar</a>
            </td>
        </tr>
    <?php endforeach; ?>
...
var href = '?c=usuario&a=Activar&ID_USUARIO='+id;
swal({
  title: "¿Esta seguro?",
  text: "Con esta acción activará al usuario",
  icon: "warning",
