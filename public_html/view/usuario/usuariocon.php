...
<body>
 ...
 ?>
            ...
            <li class="active"><a class="nav-link" href="?c=usuario&a=Listus"><i data-feather="eye"></i><span>Consultar usuario</span></a></li>
            <?php } ?>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Consultar usuarios</h4>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
                      <form action="?c=usuario&a=Index" method="post">
                      ...
                      <select class="custom-select" name="OPTION" id="selectoption">
                        ...
                        <option value="1">Identificación del usuario</option>
                    <option value="2">Nombre del usuario</option>
                    <option value="3">Administradores</option>
                    <option value="4">Cuentadantes</option>
                    <option value="5">Instructores</option>
                    <option value="6">Usuarios activos</option>
                    <option value="7">Usuarios inactivos</option>
                    <option value="8">Usuarios sin cargo</option>
                      </select>
                    </div>
