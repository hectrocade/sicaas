 ...
 ?>
      ...
      <div class="main-content">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Usuarios sin cargo</h4>
                  </div>
                  <div class="card-body">
        ...
        <td><?php echo $r->IDENTIFICACION; ?></td>
            ...
            <td>
                <a  class="btn btn-danger" onclick="redirigir1(<?php echo $r->ID_USUARIO; ?>)">Asignar</a>
            </td>
            <td>
                <a  class="btn btn-warning" onclick="redirigir2(<?php echo $r->ID_USUARIO; ?>)">Asignar</a>
            </td>
            <td>
                <a  class="btn btn-success" onclick="redirigir3(<?php echo $r->ID_USUARIO; ?>)">Asignar</a>
            </td>
        </tr>
    <?php endforeach; ?>
...
function redirigir1(id){
   
console.log('redirigir'+id);
var href = '?c=usuario&a=Admin&ID_USUARIO='+id;
swal({
  title: "¿Esta seguro?",
  text: "Asignara Rol administrador a este usuario",
  icon: "warning",
...
function redirigir2(id){
   ...
   console.log('redirigir'+id);
   var href = '?c=usuario&a=Cuenta&ID_USUARIO='+id;
   swal({
     title: "¿Esta seguro?",
     text: "Asignara Rol cuentadante a este usuario",
     icon: "warning",
     buttons: ["Cancelar", true],
     dangerMode: true,
   })
   ...
   console.log('redirigir'+id);
   var href = '?c=usuario&a=Instruc&ID_USUARIO='+id;
   swal({
     title: "¿Esta seguro?",
     text: "Asignara Rol instructor a este usuario",
     icon: "warning",
     buttons: ["Cancelar", true],
     dangerMode: true,
   })
