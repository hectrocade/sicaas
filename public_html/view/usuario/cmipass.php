            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  ...
                  <div class="card-body">
                  <form action="?c=usuario&a=Editar3" method="post">
                    <div class="form-row">
                    <input type="hidden" name="ID_USUARIO" value="<?php echo $usuario->ID_USUARIO; ?>" required>
                      <div class="form-group col-md-12">
                        ...
                        <input type="password" class="form-control" name="clavea"  id="inputEmail4" placeholder="Ingrese su contraseña actual">
                      </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="password" class="form-control" name="clave1"  id="pass1" placeholder="Ingrese su nueva contraseña">
                      </div>
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">Confirmar nueva contraseña</label>
                        <input type="password" class="form-control" name="clave2"  id="pass2" placeholder="Ingrese nuevamente su nueva contraseña">
                      </div>
