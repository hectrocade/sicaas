          ...
          <div class="row">
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                ...
                <?php foreach($this->model->Listarmi($USER) as $r): ?>
                  <h4 class="text-warning"><?php echo $r->NOMBRE; ?></h4>
                  </div>
                  <div class="card-body">
                  <br>
<b>Numero de identificación: <?php echo $r->IDENTIFICACION; ?></b><br>
<b>Celular:</b><p><?php echo $r->CELULAR; ?></p>
<b>Telefono:</b><p><?php echo $r->TELEFONO; ?></p>
<b>Dirección:</b><p><?php echo $r->DIRECCION; ?></p>
<b>Email:</b><p><?php echo $r->CORREO; ?></p>

<a  class="btn btn-primary" href="?c=usuario&a=Crud2&ID_USUARIO=<?php echo $r->ID_USUARIO; ?>">Editar</a>
                <a  class="btn btn-danger" href="?c=usuario&a=Changep&ID_USUARIO=<?php echo $r->ID_USUARIO; ?>">Cambiar mi contraseña</a>
