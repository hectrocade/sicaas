...
<?php if ($user->ID_ROL ==1) {
 ...
 ?>
                ...
                <div class="card-header">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      <form action="?c=novedad&a=Seleccionar" method="post">
                      <label>Seleccione el ambiente:</label>
                      <label class="text-danger">*</label>
                      <select class="custom-select" name="ID_CONTROL" id="selectoption">
                           <option value="1" selected>Seleccione un control de ambiente</option>
                      <?php
                        foreach ($this->model->listar_control() as $control): ?>
                            <option value="<?php echo $control -> ID_CONTROL ?>"><?php echo $control -> NOMBRE_A ?> <?php echo $control -> NOMBRE ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                    <div class="alert alert-primary alert-dismissible show fade">
                      <div class="alert-body">
                        ...
                        Señor usuario, recuerde que para poder registrar una novedad, primero debe
                         realizar un control de ambiente, por lo tanto, si no  encuentra <br> el ambiente 
                         en el que desea registrar la novedad de un activo, dirijase
                        a Control de ambiente -> Registrar y realice el control respectivo .
                      </div>
                    </div>
  ...
  <script src="assets/js/ambienteinstructor.js"></script>
</body>
