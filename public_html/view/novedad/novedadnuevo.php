...
<body>
 ...
 ?>
            ...
            <li class="active"><a class="nav-link" href="?c=novedad&a=Nuevo"><i data-feather="activity"></i><span>Registrar novedad</span></a></li>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Registrar novedad</h4>
                  </div>
                  <div class="card-body">
                  <form action="?c=novedad&a=Guardar" method="post">
                    <div class="form-row">
                      <div class="form-group col-md-4">

                      <input type="hidden" name="ID_CONTROL" value="<?php echo $VALUE ?>">
                        <label for="inputEmail4">Tipo de novedad</label>
                        <select class="custom-select" name="ID_TIPO">
                        <option selected value="0">Seleccione un tipo de novedad</option>
                        <?php

                        foreach ($this->model->listar_tipo() as $ambiente): ?>
                            <option value="<?php echo $ambiente -> ID_TIPO ?>"><?php echo $ambiente -> NOMBRE ?></option>
                        <?php endforeach; ?>
                      ...
                      <div class="form-group col-md-4">
                      <label>Activo involucrado</label>
                      <select class="custom-select" name="ID_ACTIVO">
                        <option selected value="0">Seleccione el activo con novedad</option>
                        <?php
                        foreach ($this->model->Listaractivos($VALUE) as $activo): ?>
                            <option value="<?php echo $activo -> ID_ACTIVO ?>"><?php echo $activo -> NOMBRE_CATEGORIA ?> <?php echo $activo -> MARCA ?> <?php echo $activo -> NSERIAL ?></option>
                        <?php endforeach; ?>
                      ...
                      <div class="form-group col-md-4">
                      <label>¿Notificar a mesa de ayuda?</label>
                      <select class="custom-select" name="NAM">
