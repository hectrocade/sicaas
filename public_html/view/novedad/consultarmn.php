...
<body>
 ...
 ?>
            ...
            <?php if ($user->ID_ROL ==2) { ?>
              <li class="active"><a class="nav-link" href="?c=novedad&a=consultaras&ID_USUARIO=<?php echo $user->ID_USUARIO; ?>"><i data-feather="alert-circle"></i><span>Novedades en mis ambientes</span></a></li>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Novedades en mis ambientes</h4>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
    <?php foreach($this->model->Listaras($VALUE) as $r): ?>

        <tr>
 <td><?php echo $r->NOMBREA; ?></td>
            <td> <?php echo $r->NOMBRE_CATEGORIA; ?>  <?php echo $r->MARCA; ?>  <?php echo $r->NSERIAL; ?></td>
