 ...
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu active">
                ...
                <li class="active"><a class="nav-link" href="?c=activoambiente&a=Index1">Historial de activo</a></li>
              </ul>
            </li>
            <?php } ?>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Historial de activo</h4>
                  </div>
                  <div class="card-body">
...
var href = '?c=sede&a=Desactivar&ID_SEDE='+ id;
swal({
  title: "¿Esta seguro?",
  text: "Con esta acción inhabilitara esta SEDE!",
  icon: "warning",
