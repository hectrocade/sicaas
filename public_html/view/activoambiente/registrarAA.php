...
<head>
  ...
  <title>SICAAS|Activo ambiente</title>
  <!-- General CSS Files -->
 ...
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu active">
                <li  class="active"><a href="?c=activoambiente&a=Nuevo">Asignar activo</a></li>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Asignar activo a ambiente</h4>
                  </div>
                  <div class="card-body">
                  <form action="?c=activoambiente&a=Guardar" method="post">
                    <div class="form-row">
                    <div class="form-group col-md-6">
                      <label>Ambiente: </label>
                      <label class="text-danger">*</label>
                      <select class="custom-select" name="ID_AMBIENTE" required>
                        <option selected value="0">Seleccione un ambiente: </option>
                        <?php
                            foreach ($this->model->listar_ambiente() as $amb): ?>
                                <option value="<?php echo $amb->ID_AMBIENTE ?>"><?php echo $amb->NOMBRE_A . " - " . $amb->NOMBRE?> </option>
                        <?php endforeach; ?>
                      </select>
                      </div>
                      <div class="form-group col-md-6">
                      <label>Activo: </label>
                      <label class="text-danger">*</label>
                      <select class="custom-select" name="ID_ACTIVO" required>
                        <option selected value="0">Seleccione un activo: </option>
                        <?php
                            foreach ($this->model->listar_activo() as $sed): ?>
                                <option value="<?php echo $sed->ID_ACTIVO ?>"><?php echo $sed->NOMBRE_CATEGORIA ?> <?php echo " - "; ?> <?php echo $sed->SERIAL_A ?></option>
                        <?php endforeach; ?>
                      </select>
                      </div>
                    </div>
