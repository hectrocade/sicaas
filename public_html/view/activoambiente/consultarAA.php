 ...
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu active">
                ...
                <li class="active"><a class="nav-link" href="?c=activoambiente&a=Index">Activos asignados</a></li>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-warning">Activos asignados</h4>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <?php foreach($this->model->Listar() as $r): ?>
                            <tr>
                                <td><?php echo $r->NOMBREA; ?></td>
                                <td><?php echo $r->NOMBRE_CATEGORIA; ?> <?php echo $r->MARCA; ?> SERIAL: <?php echo $r->NSERIAL; ?></td>
                                <td><?php echo $r->FECHA_ENTRADA; ?></td>
                                <td>
                                    <a class="btn btn-danger" onclick="redirigir(<?php echo $r->ID_DETALLE;?>)">Terminar</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
...
var href = '?c=activoambiente&a=Desactivar&ID_ASIGNACION='+ id;
swal({
  title: "¿Esta seguro?",
  text: "Con esta acción concluira la permanencia del activo en ese ambiente!",
  icon: "warning",
