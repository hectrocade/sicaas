 ...
 ?>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="?c=categoria&a=consultarC">Consultar categoria</a></li>
              </ul>
            </li>
            <?php } ?>
            ...
            <div class="col-12 col-sm-12 col-lg-12">
              <div class="card ">
                <div class="card-header">
                  <h4 class="text-warning">Actualizar Categoría</h4>
                  </div>
                  <div class="card-body">
                  <form action="?c=categoria&a=Editar" method="post">
                    <div class="form-row">
                    <input type="hidden" name="ID_CATEGORIA" value="<?php echo $categoria->ID_CATEGORIA; ?>" required> 
